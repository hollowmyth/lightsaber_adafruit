...
import audioio
import audiocore
import audiomixer #CHANGE TO CODE
import busio
import board 
# import librosa  #CHANGE TO CODE
import neopixel 
...
while True:
    ...
    if not switch.value:                    # button pressed?
        ...
        if accel_total > HIT_THRESHOLD:   # Large acceleration = HIT
            ...
            if mixer.voice[0].playing:               # And sound currently playing...
